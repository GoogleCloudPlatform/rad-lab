...
![Project settings for your Firebase project](../../../../radlab-ui/images/settings.png)

Add a Web Application by clicking on the `</>`-icon at the bottom of the page:
![Web application settings](../../../../radlab-ui/images/web_settings.png)

Set the **App nickname** to **RAD Lab UI**, click on **Register app**:
![Web application settings](../../../../radlab-ui/images/add_firebase_one.png)

Click on **Continue to console**.
![Web application settings - finalization](../../../../radlab-ui/images/add_firebase_two.png)
