...
:::warning
If you've never used Firebase in your Google Cloud organization before, please execute [First Time Use](#first-time-use).  If you already have Firebase projects running in your Google Cloud organization or you have in the past, please execute [Returning Firebase User](#returning-firebase-user).

If you're not sure, simply execute the steps as described in [First Time Use](#first-time-use).
:::
...
:::warning first time
Only execute these steps if you already have one or more Firebase applications in your Google Cloud organization.  If that is not the case, or you are not sure, please run the steps in the previous section, titled **First time Firebase use**.
:::
