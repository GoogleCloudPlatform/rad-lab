...
resource "time_sleep" "wait_120_seconds" {
  count = var.set_shielded_vm_policy || var.set_external_ip_policy || var.set_trustedimage_project_policy || (var.set_domain_restricted_sharing_policy && var.create_budget && var.billing_budget_pubsub_topic) || var.enable_services ? 1 : 0
