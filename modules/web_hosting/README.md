...
| *region* | Primary region where the CloudSQL, Compute Instance and VPC subnet will be deployed. List - https://cloud.google.com/compute/docs/regions-zones#available | <code title="">string</code> |  | <code title="">us-central1</code> |
| *region_secondary* | Secondary region where the Compute Instance and VPC subnet will be deployed. List - https://cloud.google.com/compute/docs/regions-zones#available | <code title="">string</code> |  | <code title="">asia-south1</code> |
