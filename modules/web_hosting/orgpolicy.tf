...
#   count = var.set_shielded_vm_policy || var.set_external_ip_policy || var.set_trustedimage_project_policy ? 1 : 0
  count = var.set_shielded_vm_policy || var.set_bucket_level_access_policy ? 1 : 0
  depends_on = [
