...
Below Architechture Diagram is the base representation of what will be created as a part of [RAD Lab Launcher](../../radlab-launcher/radlab.py) and RAD Lab UI.
...
module "existing_project" {
  ...
  project_id_prefix    = "gen-ai-project-id"
...
module "existing_project_and_network" {
  ...
  network_name   = "gen-ai-network"
  subnet_name    = "gen-ai-subnetwork"
...
| *network_name* | Name of the network to be created | <code title="">string</code> |  | <code title="">network-ai-workbench</code> |
...
| *project_id_prefix* | If `create_project` is true, this will be the prefix of the Project ID & name created. If `create_project` is false this will be the actual Project ID, of the existing project where you want to deploy the module | <code title="">string</code> |  | <code title="">radlab-gen-ai</code> |
...
## Access RAD Lab Gen AI Notebooks
