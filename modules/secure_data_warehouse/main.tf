...
locals {
  ...
  project_services_data_ingest = var.billing_budget_pubsub_topic ? distinct(concat(local.default_apis_data_ingest,["pubsub.googleapis.com"])) : local.default_apis_data_ingest

  # default_apis_data_ingest = [
  #   "compute.googleapis.com",
  #   "pubsub.googleapis.com"
  # ]
  # project_services_data_ingest = var.enable_services ? (var.billing_budget_pubsub_topic ? distinct(concat(local.default_apis_data_ingest,["pubsub.googleapis.com"])) : local.default_apis_data_ingest) : []
