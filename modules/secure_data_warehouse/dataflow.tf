...
#   parameters = {
#     query                          = "SELECT email, name, street, city, state, zip, dob, dl_id, exp_date FROM [${module.project_radlab_sdw_non_conf_data.project_id}:${google_bigquery_table.sdw_non_conf_sample_data.dataset_id}.${google_bigquery_table.sdw_non_conf_sample_data.table_id}] LIMIT 10000"
