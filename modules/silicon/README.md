...
| *zone* | Cloud Zone associated to the AI Notebooks. List - https://cloud.google.com/compute/docs/regions-zones#available | <code title="">string</code> |  | <code title="">us-east4-c</code> |
